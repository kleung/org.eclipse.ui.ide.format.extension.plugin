...
import org.eclipse.ui.ide.format.extension.plugin.ui.data.ZipFileExporter;
...
public class ArchiveFileExportOperation implements IRunnableWithProgress {
	...
	protected void addError(String message, Throwable e) {
        errorTable.add(new Status(IStatus.ERROR,
                "org.eclipse.ui.ide.format.extension.plugin", 0, message, e)); //$NON-NLS-1$
    }
	...
	public IStatus getStatus() {
        ...
        return new MultiStatus(
        		"org.eclipse.ui.ide.format.extension.plugin", //$NON-NLS-1$
                IStatus.OK,
                errors,
