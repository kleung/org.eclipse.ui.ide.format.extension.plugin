...
import org.eclipse.ui.internal.wizards.datatransfer.ArchiveFileFormatExtensionProjectsImportPage;
...
public class FormatExtensionProjectImportWizard extends Wizard implements
        IImportWizard {
    private static final String EXTERNAL_PROJECT_SECTION = "FormatExtensionArchiveProjectImportWizard";//$NON-NLS-1$
	private ArchiveFileFormatExtensionProjectsImportPage mainPage;
     ...
     */
    public FormatExtensionProjectImportWizard() {
    	this(null);
    }
     ...
     * @since 3.5
     */
    public FormatExtensionProjectImportWizard(String initialPath)
    {
        super();
    ...
    public void addPages() {
        super.addPages();
		mainPage = new ArchiveFileFormatExtensionProjectsImportPage(
