 ...
 *******************************************************************************/
package org.eclipse.ui.ide.format.extension.wizard;
...
import org.eclipse.ui.internal.wizards.datatransfer.ArchiveFileFormatExtensionResourceImportPage;
 ...
 */
public class FormatExtensionArchiveFileImportWizard extends Wizard implements IImportWizard {
	private IWorkbench workbench;

	private IStructuredSelection selection;

	private ArchiveFileFormatExtensionResourceImportPage mainPage;

	/**
	 * Creates a wizard for importing resources into the workspace from a zip
	 * file.
	 */
	public FormatExtensionArchiveFileImportWizard() {
		AbstractUIPlugin plugin = WorkbenchPlugin.getDefault();
		IDialogSettings workbenchSettings = plugin.getDialogSettings();
		IDialogSettings section = workbenchSettings
				.getSection("FormatExtensionArchiveFileImportWizard");//$NON-NLS-1$
		if (section == null) {
			section = workbenchSettings.addNewSection("FormatExtensionArchiveFileImportWizard");//$NON-NLS-1$
		}
	...
	public void addPages() {
		super.addPages();
		mainPage = new ArchiveFileFormatExtensionResourceImportPage(workbench,
